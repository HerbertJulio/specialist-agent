...
features:
  ...
  - icon: 🏗️
    title: "@builder"
    details: Crie modulos, componentes, servicos, composables e testes — detecta automaticamente o que voce precisa.
  - icon: ✅
    title: "@reviewer"
  ...
  - icon: 🪶
    ...
    details: "Vue 3, React, Next.js, SvelteKit — agentes, skills e padroes de arquitetura para cada stack."
---

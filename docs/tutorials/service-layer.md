...
::: info Framework Note
This tutorial uses **Vue 3** as an example. The concepts (services, adapters, composables) apply to any framework — each has its own idiomatic equivalents. Specialist Agent is framework-agnostic.
:::

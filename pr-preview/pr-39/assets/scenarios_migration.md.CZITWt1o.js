import{_ as a,o as n,c as e,a4 as p}from"./chunks/framework.CBk68Tg5.js";const g=JSON.parse('{"title":"Migration","description":"","frontmatter":{},"headers":[],"relativePath":"scenarios/migration.md","filePath":"scenarios/migration.md"}'),t={name:"scenarios/migration.md"};function i(l,s,r,o,c,d){return n(),e("div",null,[...s[0]||(s[0]=[p(`<h1 id="migration" tabindex="-1">Migration <a class="header-anchor" href="#migration" aria-label="Permalink to &quot;Migration&quot;">​</a></h1><p>Real scenarios for migrating and modernizing code.</p><h2 id="typescript" tabindex="-1">JavaScript to TypeScript <a class="header-anchor" href="#typescript" aria-label="Permalink to &quot;JavaScript to TypeScript {#typescript}&quot;">​</a></h2><p><strong>Goal:</strong> Migrate a JavaScript project to TypeScript.</p><p><strong>Command:</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Migrate the user module from JavaScript to TypeScript</span></span></code></pre></div><p><strong>What happens:</strong></p><ol><li><strong>Scan</strong> — Analyzes current JS files and patterns</li><li><strong>Plan</strong> — Creates migration order (leaf files first)</li><li><strong>Migrate</strong> — Converts files with proper types</li><li><strong>Verify</strong> — Ensures build passes with strict mode</li></ol><p><strong>Result:</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Migration: JS → TypeScript</span></span>
...
<span class="line"><span>  npm test: 15/15 passing</span></span></code></pre></div><hr><h2 id="quick-tips" tabindex="-1">Quick Tips <a class="header-anchor" href="#quick-tips" aria-label="Permalink to &quot;Quick Tips&quot;">​</a></h2><h3 id="migration-strategy" tabindex="-1">Migration Strategy <a class="header-anchor" href="#migration-strategy" aria-label="Permalink to &quot;Migration Strategy&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># Specify what to migrate</span></span>
...
<span class="line"><span>Migrate the dashboard to Vue 3 — keep the same API contracts</span></span></code></pre></div><h3 id="common-migrations" tabindex="-1">Common Migrations <a class="header-anchor" href="#common-migrations" aria-label="Permalink to &quot;Common Migrations&quot;">​</a></h3><table tabindex="0"><thead><tr><th>From</th><th>To</th><th>Agent</th></tr></thead><tbody><tr><td>JavaScript</td><td>TypeScript</td><td>@migrator</td></tr><tr><td>React</td><td>Vue 3</td><td>@migrator</td></tr><tr><td>REST</td><td>GraphQL</td><td>@api</td></tr><tr><td>Monolith</td><td>Microservices</td><td>@architect</td></tr><tr><td>Class components</td><td>Functional</td><td>@refactor</td></tr></tbody></table><hr><h2 id="related-scenarios" tabindex="-1">Related Scenarios <a class="header-anchor" href="#related-scenarios" aria-label="Permalink to &quot;Related Scenarios&quot;">​</a></h2><ul><li><a href="/specialist-agent/pr-preview/pr-39/scenarios/build-feature.html">Build Features</a> — Build with modern patterns</li><li><a href="/specialist-agent/pr-preview/pr-39/scenarios/code-review.html">Code Review</a> — Review migrated code</li><li><a href="/specialist-agent/pr-preview/pr-39/scenarios/infrastructure.html">Infrastructure</a> — Update deployment for new stack</li></ul>`,35)])])}const h=a(t,[["render",i]]);export{g as __pageData,h as default};

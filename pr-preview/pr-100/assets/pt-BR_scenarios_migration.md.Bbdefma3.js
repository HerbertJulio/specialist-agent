...
<span class="line"><span>  npm test: 15/15 passing</span></span></code></pre></div><hr><h2 id="architecture" tabindex="-1">Migração de Arquitetura <a class="header-anchor" href="#architecture" aria-label="Permalink to &quot;Migração de Arquitetura {#architecture}&quot;">​</a></h2><p><strong>Objetivo:</strong> Migrar entre padrões de arquitetura.</p><p><strong>Comando:</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/migrate-architecture mvc to clean full project</span></span></code></pre></div><p><strong>O que acontece:</strong></p><ol><li><strong>Avaliar</strong> - Detecta a arquitetura atual com score de confiança</li><li><strong>Planejar</strong> - Mapeia arquivos para novos locais, ordena por acoplamento</li><li><strong>Executar</strong> - Move arquivos, cria camadas, atualiza imports</li><li><strong>Validar</strong> - Check TypeScript, regras de import, testes</li></ol><p><strong>Resultado:</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Architecture Migration Complete</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>docs/ARCHITECTURE.md: generated</span></span></code></pre></div><p><strong>Padrões suportados:</strong> Modular, Clean Architecture, Hexagonal, DDD, FSD, CQRS, Event-Driven, Modular Monolith, Atomic, MVC, Microservices, Serverless, e mais.</p><p><strong>Variantes:</strong></p><ul><li><strong>Full</strong> - Implementação completa com todas as camadas</li><li><strong>Lite</strong> - Menos camadas, mesmos princípios (times menores)</li></ul><hr><h2 id="dicas-rapidas" tabindex="-1">Dicas Rápidas <a class="header-anchor" href="#dicas-rapidas" aria-label="Permalink to &quot;Dicas Rápidas&quot;">​</a></h2><h3 id="estrategia-de-migracao" tabindex="-1">Estratégia de Migração <a class="header-anchor" href="#estrategia-de-migracao" aria-label="Permalink to &quot;Estratégia de Migração&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># Especifique o que migrar</span></span>
...
<span class="line"><span>Migrate the dashboard to Vue 3 - keep the same API contracts</span></span></code></pre></div><h3 id="migracoes-comuns" tabindex="-1">Migrações Comuns <a class="header-anchor" href="#migracoes-comuns" aria-label="Permalink to &quot;Migrações Comuns&quot;">​</a></h3><table tabindex="0"><thead><tr><th>De</th><th>Para</th><th>Agent</th></tr></thead><tbody><tr><td>JavaScript</td><td>TypeScript</td><td>@migrator</td></tr><tr><td>React</td><td>Vue 3</td><td>@migrator</td></tr><tr><td>REST</td><td>GraphQL</td><td>@api</td></tr><tr><td>Monolito</td><td>Microsserviços</td><td>@architect</td></tr><tr><td>MVC</td><td>Clean Architecture</td><td>@architect</td></tr><tr><td>Flat</td><td>Modular</td><td>@architect</td></tr><tr><td>Modular</td><td>Hexagonal</td><td>@architect</td></tr><tr><td>Class components</td><td>Functional</td><td>@refactor</td></tr></tbody></table><hr><h2 id="cenarios-relacionados" tabindex="-1">Cenários Relacionados <a class="header-anchor" href="#cenarios-relacionados" aria-label="Permalink to &quot;Cenários Relacionados&quot;">​</a></h2><ul><li><a href="/pr-preview/pr-100/pt-BR/scenarios/build-feature.html">Construir Funcionalidades</a> - Construa com padrões modernos</li><li><a href="/pr-preview/pr-100/pt-BR/scenarios/code-review.html">Revisão de Código</a> - Revise o código migrado</li><li><a href="/pr-preview/pr-100/pt-BR/scenarios/infrastructure.html">Infraestrutura</a> - Atualize o deploy para o novo stack</li></ul>`,47)])])}const h=s(t,[["render",i]]);export{g as __pageData,h as default};

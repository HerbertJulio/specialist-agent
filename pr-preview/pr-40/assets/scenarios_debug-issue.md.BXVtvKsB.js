import{_ as n,o as a,c as e,a4 as p}from"./chunks/framework.CyBk-vIr.js";const h=JSON.parse('{"title":"Debug Issues","description":"","frontmatter":{},"headers":[],"relativePath":"scenarios/debug-issue.md","filePath":"scenarios/debug-issue.md"}'),l={name:"scenarios/debug-issue.md"};function t(i,s,o,r,c,d){return a(),e("div",null,[...s[0]||(s[0]=[p(`<h1 id="debug-issues" tabindex="-1">Debug Issues <a class="header-anchor" href="#debug-issues" aria-label="Permalink to &quot;Debug Issues&quot;">​</a></h1><p>Real scenarios for finding and fixing bugs.</p><h2 id="api-error" tabindex="-1">API Error <a class="header-anchor" href="#api-error" aria-label="Permalink to &quot;API Error {#api-error}&quot;">​</a></h2><p><strong>Goal:</strong> Fix 500 error on login.</p><p><strong>Command:</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Debug the 500 error when users try to login</span></span></code></pre></div><p><strong>What happens:</strong></p><ol><li><strong>Gather</strong> — Collects error logs, request/response</li><li><strong>Analyze</strong> — Forms hypothesis based on evidence</li><li><strong>Test</strong> — Verifies hypothesis</li><li><strong>Fix</strong> — Implements and validates solution</li></ol><p><strong>Result:</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Debug: Login 500 Error</span></span>
...
<span class="line"><span>Actual: After login, stays on login page with no error</span></span></code></pre></div><hr><h2 id="related-scenarios" tabindex="-1">Related Scenarios <a class="header-anchor" href="#related-scenarios" aria-label="Permalink to &quot;Related Scenarios&quot;">​</a></h2><ul><li><a href="/specialist-agent/pr-preview/pr-40/scenarios/build-feature.html">Build Features</a> — Build correctly to avoid bugs</li><li><a href="/specialist-agent/pr-preview/pr-40/scenarios/code-review.html">Code Review</a> — Catch bugs before they ship</li><li><a href="/specialist-agent/pr-preview/pr-40/scenarios/performance.html">Performance</a> — Debug slow code</li></ul>`,57)])])}const g=n(l,[["render",t]]);export{h as __pageData,g as default};

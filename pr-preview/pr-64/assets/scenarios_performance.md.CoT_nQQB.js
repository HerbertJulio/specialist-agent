...
<span class="line"><span>The dashboard takes 3 seconds to load after login</span></span></code></pre></div><h3 id="common-wins" tabindex="-1">Common Wins <a class="header-anchor" href="#common-wins" aria-label="Permalink to &quot;Common Wins&quot;">​</a></h3><table tabindex="0"><thead><tr><th>Issue</th><th>Solution</th></tr></thead><tbody><tr><td>Large bundle</td><td>Code splitting + tree shaking</td></tr><tr><td>Slow queries</td><td>Indexes + pagination</td></tr><tr><td>Many re-renders</td><td>Memoization + virtualization</td></tr><tr><td>Slow API</td><td>Caching + parallel requests</td></tr></tbody></table><hr><h2 id="related-scenarios" tabindex="-1">Related Scenarios <a class="header-anchor" href="#related-scenarios" aria-label="Permalink to &quot;Related Scenarios&quot;">​</a></h2><ul><li><a href="/pr-preview/pr-64/scenarios/debug-issue.html">Debug Issues</a> - Debug performance-related bugs</li><li><a href="/pr-preview/pr-64/scenarios/infrastructure.html">Infrastructure</a> - Scale for performance</li><li><a href="/pr-preview/pr-64/scenarios/api-design.html">API Design</a> - Design efficient APIs</li></ul>`,41)])])}const g=a(l,[["render",i]]);export{h as __pageData,g as default};

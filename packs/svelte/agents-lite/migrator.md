---
name: migrator
description: "MUST BE USED when migrating legacy code to the target architecture. Use for Svelte 4 -> 5 conversion, SvelteKit 1 -> 2 migration, or full module modernization."
model: haiku

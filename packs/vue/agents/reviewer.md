...
### 2. Pattern Checks
Run `/review-check-architecture $SCOPE` and include the results in the review. This skill contains all framework-specific automated checks -- do NOT duplicate them here.

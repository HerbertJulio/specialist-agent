...
<span class="line"><span>Migrate the dashboard to Vue 3 - keep the same API contracts</span></span></code></pre></div><h3 id="migracoes-comuns" tabindex="-1">Migrações Comuns <a class="header-anchor" href="#migracoes-comuns" aria-label="Permalink to &quot;Migrações Comuns&quot;">​</a></h3><table tabindex="0"><thead><tr><th>De</th><th>Para</th><th>Agent</th></tr></thead><tbody><tr><td>JavaScript</td><td>TypeScript</td><td>@migrator</td></tr><tr><td>React</td><td>Vue 3</td><td>@migrator</td></tr><tr><td>REST</td><td>GraphQL</td><td>@api</td></tr><tr><td>Monolito</td><td>Microsserviços</td><td>@architect</td></tr><tr><td>Class components</td><td>Functional</td><td>@refactor</td></tr></tbody></table><hr><h2 id="cenarios-relacionados" tabindex="-1">Cenários Relacionados <a class="header-anchor" href="#cenarios-relacionados" aria-label="Permalink to &quot;Cenários Relacionados&quot;">​</a></h2><ul><li><a href="/pt-BR/scenarios/build-feature.html">Construir Funcionalidades</a> - Construa com padrões modernos</li><li><a href="/pt-BR/scenarios/code-review.html">Revisão de Código</a> - Revise o código migrado</li><li><a href="/pt-BR/scenarios/infrastructure.html">Infraestrutura</a> - Atualize o deploy para o novo stack</li></ul>`,35)])])}const h=s(t,[["render",i]]);export{g as __pageData,h as default};
